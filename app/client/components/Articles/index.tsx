...
const postData: DataType[] = [
    {
        time: "",
        heading: 'Иванов Иван Иванович',
        heading2: 'Педиатр',
        name: "Работает с",
        date: '05.07.2023',
        imgSrc: "/images/doctors/doctor1.jpg",
    },
    {
        time: "",
        heading: 'Максимов Максим Максимович',
        heading2: 'Хирург',
        name: "Работает с",
        date: '05.07.2023',
        imgSrc: "/images/doctors/doctor3.jpg",
    },
    {
        time: "",
        heading: 'Авани Аджит',
        ...
        name: "Работает с",
        date: '05.07.2023',
        imgSrc: "/images/doctors/docto2.png",
    },
    {
        time: "",
        heading: 'Олегов Олег Олегович',
        heading2: 'Гинеколог',
        name: "Работает с",
        date: '05.05.20232',
        imgSrc: "/images/doctors/doctor3.jpg",
    ...
    {
        time: "",
        heading: 'Дмитриев Дмитрий Дмитриевич',
        heading2: 'Уролог',
        name: "Работает с",
        date: '05.07.2023',
        imgSrc: "/images/doctors/doctor1.jpg",
    ...
    {
        time: "",
        heading: 'Александров Александр Александрович',
        heading2: 'Терапевт',
        name: "Работает с",
        date: '05.07.2023',
        imgSrc: "/images/doctors/doctor3.jpg",
            ...
            <div className="bg-lightgrey py-20" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-4xl sm:text-6xl font-bold">Наши специалисты.</h3>
                    </div>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    <Image src={items.imgSrc} alt="gaby" width={400} height={250} className="m-auto" />
